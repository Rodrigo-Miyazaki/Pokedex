...
export class LoginServiceService {
  ...
  loginAuth(userObj: any) {
    ...
    return this._http.post( `${environment.url}/login`, { uname: userObj.uname, upass: userObj.upass }, { observe: 'response', headers: this.headerOptions });
  }

  setupAuth() {
    return this._http.post(`${environment.url}/tfa/setup`, {}, { observe: 'response' })
  }

  registerUser(userObj: any) {
    return this._http.post(`${environment.url}/register`, { uname: userObj.uname, upass: userObj.upass }, { observe: "response" });
  }
